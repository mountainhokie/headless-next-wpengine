...
const Copy = () => {
  return (
    <>
      ...
      <h1 className="max-w-4xl text-center text-4xl font-black text-black leading-[1.15] md:text-6xl md:leading-[1.15]">
        Launch your product with a cool landing page
      </h1>
      <p className="mx-auto my-4 max-w-3xl text-center text-black text-base leading-relaxed md:my-6 md:text-xl md:leading-relaxed">
